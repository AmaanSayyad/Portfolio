...
const aboutSentence5: AboutSentence = [
	{ type: "text", content: " Won 42 Web3 hackathons out of 70+ participated" , className: "font-semibold text-white/70"},
	{ type: "emoji", content: "🏆", className: "text-4xl sm:text-5xl md:text-6xl inline-block" },
];
...
const projects: Data["projects"]["projects"] = [
	...
	},
	{
		...
		color: "#321D44",
		githubLink: "https://github.com/amaansayyad/gemetra-mnee",
		liveLink: "https://gemetra-mnee.vercel.app/",
		videoDemo: "https://drive.google.com/file/d/1p-Y-yVMDD6q8XKXJ8m3Sw0Gmakgmno4m/view?usp=sharing",
		demoVideo: "https://youtu.be/FEmaygRs1gs",
		deckLink: "https://docs.google.com/presentation/d/1CV3kaE1mY7rgmB9bTwZTBLGR6BdLryRtaHD4F3MK4M8/edit?usp=sharing",
	},
	{
		title: "DunkVerse",
		description:
