...
export const metadata: Metadata = {
  ...
  description:
    'Co-Founder & CEO at Bharat DAO. 4+ years in Web3. Built 25+ Web3 projects. Won 35 hackathons. Worked with 8 Web3 companies. 12+ speaking engagements. Open to opportunities in DevRel, Blockchain Development, and Entrepreneurship.',
  ...
  twitter: {
    ...
    description:
      'Co-Founder & CEO at Bharat DAO. Built 25+ Web3 projects. Won 35 hackathons. 4+ years in Web3.',
    creator: '@amaanbiz',
    site: '@amaanbiz',
    images: [
      {
  ...
  openGraph: {
    title: 'Amaan Sayyad | DevRel | Blockchain Developer | Entrepreneur',
    description:
      'Co-Founder & CEO at Bharat DAO. 4+ years in Web3. Built 25+ Web3 projects. Won 35 hackathons. Worked with 8 Web3 companies. Open to opportunities.',
    type: 'website',
    locale: 'en_US',
