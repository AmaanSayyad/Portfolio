...
const volunteerExperiences = [
  ...
  },
  {
    ...
    location: 'Remote',
    description: 'Testing the Courses before their release. Communicating with the Backend Team if there is any issue with the course. Generating and providing feedback to help the Instructor to make the course better and effective on release. Making the backend team understand if the course is not up to the mark or something is improper.',
